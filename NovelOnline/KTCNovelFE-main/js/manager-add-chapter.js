...
$(document).ready(function() {
  ...
  const bookName = url.substring(url.lastIndexOf("/"), url.lastIndexOf("/", url.lastIndexOf("/")-1)+1);
  $('.add-btn').click(function(event) {
      ...
      $.ajax({
          type: 'POST',
          url: `http://localhost:8080/nguoi-dang/novel/khau-van-tien-dao/chapter/add/process`,
          data: formData,
          processData: false,
          contentType: false,
